    ...
    <div class="sensitiveTaskManage">
        ...
        <section>
            <el-table
                ...
                <el-table-column prop="total" label="任务数据量"></el-table-column>
                ...
                tableData: [
                    {
                        id: 1,
                        type: 'MYSQL',
                        createTime: '2018-02-27 18:10:10',
                        endTime: '2018-02-27 18:10:10',
                        status: '脱敏完成',
                        progress: 100,
                        total: 155,
                        comment: '我是备注'
